...
goog.exportSymbol('proto.akushon_interfaces.proto.CurrentJoints', null, global);
 ...
 * @constructor
 */
proto.akushon_interfaces.proto.CurrentJoints = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.akushon_interfaces.proto.CurrentJoints, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.akushon_interfaces.proto.CurrentJoints.displayName = 'proto.akushon_interfaces.proto.CurrentJoints';
}
 ...
 * @return {!Object}
 */
proto.akushon_interfaces.proto.CurrentJoints.prototype.toObject = function(opt_includeInstance) {
  return proto.akushon_interfaces.proto.CurrentJoints.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.akushon_interfaces.proto.CurrentJoints} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.akushon_interfaces.proto.CurrentJoints.toObject = function(includeInstance, msg) {
  var f, obj = {
    msgJoints: jspb.Message.getFieldWithDefault(msg, 1, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.akushon_interfaces.proto.CurrentJoints}
 */
proto.akushon_interfaces.proto.CurrentJoints.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.akushon_interfaces.proto.CurrentJoints;
  return proto.akushon_interfaces.proto.CurrentJoints.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.akushon_interfaces.proto.CurrentJoints} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.akushon_interfaces.proto.CurrentJoints}
 */
proto.akushon_interfaces.proto.CurrentJoints.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.akushon_interfaces.proto.CurrentJoints.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.akushon_interfaces.proto.CurrentJoints.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.akushon_interfaces.proto.CurrentJoints} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.akushon_interfaces.proto.CurrentJoints.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getMsgJoints();
  if (f.length > 0) {
    writer.writeString(
      1,
      f
...
/**
 * optional string msg_joints = 1;
 * @return {string}
 */
proto.akushon_interfaces.proto.CurrentJoints.prototype.getMsgJoints = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.akushon_interfaces.proto.CurrentJoints} returns this
 */
